	...
	Convey("Given I have a non existing aws definition", t, func() {
		Convey("When I apply aws1.yml", func() {
			...
			Convey("Then I should create a valid service", func() {
				...
				So(event.DatacenterAccessToken, ShouldEqual, "R80hNNKU3hCl2MbGC30w+azPA6lTrrtUDYQo6VWLUIVBDI7Yh5MCX3aarKGCQVkfXvc=")
				So(event.DatacenterAccessKey, ShouldEqual, "iqMQUK8jivJ3tm4QAJSBcZzRoM7dTzQx/bVx6uUc1eUf6epaap4Xol/P0XUVAFxf")
				...
				So(eventF.DatacenterAccessToken, ShouldEqual, "R80hNNKU3hCl2MbGC30w+azPA6lTrrtUDYQo6VWLUIVBDI7Yh5MCX3aarKGCQVkfXvc=")
				So(eventF.DatacenterAccessKey, ShouldEqual, "iqMQUK8jivJ3tm4QAJSBcZzRoM7dTzQx/bVx6uUc1eUf6epaap4Xol/P0XUVAFxf")
				...
				So(eventI.DatacenterAccessToken, ShouldEqual, "R80hNNKU3hCl2MbGC30w+azPA6lTrrtUDYQo6VWLUIVBDI7Yh5MCX3aarKGCQVkfXvc=")
				So(eventI.DatacenterAccessKey, ShouldEqual, "iqMQUK8jivJ3tm4QAJSBcZzRoM7dTzQx/bVx6uUc1eUf6epaap4Xol/P0XUVAFxf")
		...
		Convey("When I apply aws12.yml", func() {
			...
			Convey("Then it should create the new 10.2.0.0/24 network", func() {
				...
				So(eventN.DatacenterAccessToken, ShouldEqual, "R80hNNKU3hCl2MbGC30w+azPA6lTrrtUDYQo6VWLUIVBDI7Yh5MCX3aarKGCQVkfXvc=")
				So(eventN.DatacenterAccessKey, ShouldEqual, "iqMQUK8jivJ3tm4QAJSBcZzRoM7dTzQx/bVx6uUc1eUf6epaap4Xol/P0XUVAFxf")
