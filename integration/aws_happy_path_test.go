	...
	Convey("Given I have a non existing aws definition", t, func() {
		Convey("When I apply aws1.yml", func() {
			...
			Convey("Then I should create a valid service", func() {
				...
				So(event.DatacenterAccessToken, ShouldEqual, "fake_up_to_16_characters")
				So(event.DatacenterAccessKey, ShouldEqual, "up_to_16_characters_secret")
				...
				So(eventF.DatacenterAccessToken, ShouldEqual, "fake_up_to_16_characters")
				So(eventF.DatacenterAccessKey, ShouldEqual, "up_to_16_characters_secret")
				...
				So(eventI.DatacenterAccessToken, ShouldEqual, "fake_up_to_16_characters")
				So(eventI.DatacenterAccessKey, ShouldEqual, "up_to_16_characters_secret")
		...
		Convey("When I apply aws12.yml", func() {
			...
			Convey("Then it should create the new 10.2.0.0/24 network", func() {
				...
				So(eventN.DatacenterAccessToken, ShouldEqual, "fake_up_to_16_characters")
				So(eventN.DatacenterAccessKey, ShouldEqual, "up_to_16_characters_secret")
		...
		Convey("When I apply aws13.yml", func() {
			...
			Convey("Then it should create the new elb-1 elb", func() {
				...
				So(eventLB.DatacenterToken, ShouldEqual, "fake_up_to_16_characters")
				So(eventLB.DatacenterSecret, ShouldEqual, "up_to_16_characters_secret")
